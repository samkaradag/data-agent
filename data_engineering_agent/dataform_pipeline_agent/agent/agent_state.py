"""
This module defines the `AgentState` class, which represents the state of the agent
during its execution.

The `AgentState` class stores various information relevant to the agent's progress,
including user input, conversation history, the next task to execute, data related
to tables and files, compilation results, errors, generated code, transformations,
...
class AgentState(BaseModel):
    ...
    Attributes:
        ...
        target_tables (Optional[List[Dict[str, Any]]]): List of target tables.
